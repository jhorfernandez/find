         ...
         <form name="opciones">
              <table class='table table-bordered'>
                ...
                <?php
                 ...
                 $query = "SELECT DISTINCT citas.id, citas.especialidad, citas.lugar, citas.fecha, citas.hora, citas.cedula, citas.estado, pacientes.nombre, pacientes.apellido FROM citas INNER JOIN pacientes ON citas.cedula = pacientes.cedula AND citas.estado = 1 AND citas.cedula = '$cedula'";
